            	...
            	<table id="main_table" cellpadding="0" cellspacing="0" >
                    ...
                    <!--{foreach from=$menuList item=item}-->
                		<tr>
                            ...
                            <td><b><!--{$item.sort}--></b></td>
                            <td class="last">
                            	<a href="menu.php?action=edit&id=<!--{$item.id}-->&page=<!--{$page}-->" title="编辑"><img src="<!--{$assets}-->/images/pencil.png" alt="编辑" /></a>
								<!--{if $item.locked<2}-->
                    	...
                    	<tr>
                            ...
                            <td><!--{$child.sort}--></td>
                            <td class="last">
                            	<a href="menu.php?action=edit&id=<!--{$child.id}-->&page=<!--{$page}-->" title="编辑"><img src="<!--{$assets}-->/images/pencil.png" alt="编辑" /></a>
                                <!--{if $child.locked<2}-->
