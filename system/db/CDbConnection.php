	...
	public function getSchema()
	{
		...
		else
		{
			...
			if(isset($this->driverMap[$driver]))
				...
				return $this->_schema=createComponent($this->driverMap[$driver], $this);
			else
				throw new CDbException('CDbConnection does not support reading schema for '.$driver.' database.');
		}
	}
