...
class CSqliteSchema extends CDbSchema
{
	...
	{
		throw new CDbException(strFormat( 'Dropping DB column is not supported by SQLite.'));
	}
	...
	{
		throw new CDbException(strFormat( 'Renaming a DB column is not supported by SQLite.'));
	}
	...
	{
		throw new CDbException(strFormat( 'Adding a foreign key constraint to an existing table is not supported by SQLite.'));
	}
	...
	{
		throw new CDbException(strFormat( 'Dropping a foreign key constraint is not supported by SQLite.'));
	}
	...
	{
		throw new CDbException(strFormat( 'Altering a DB column is not supported by SQLite.'));
	}
	...
	{
		throw new CDbException(strFormat( 'Adding a primary key after table has been created is not supported by SQLite.'));
	}
	...
	{
		throw new CDbException(strFormat( 'Removing a primary key after table has been created is not supported by SQLite.'));
